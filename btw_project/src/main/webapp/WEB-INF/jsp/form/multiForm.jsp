...
<body>
	<form action="/form/saveMultiObjectForm.bt" method="post">
		<h1>Multi Form (1)</h1>
		<table id="attr-input-type-keywords">
			...
			<tbody>
				...
				<tr>
					<td><dfn data-dfn-for="input/type" data-dfn-type="attr-value"
							data-export="" id="attr-valuedef-input-type-image">
							<code>image</code>
							<a class="self-link"
								href="sec-forms.html#attr-valuedef-input-type-image"></a>
						</dfn></td>
					<td><code>
							<a data-link-type="element-sub"
								href="sec-forms.html#element-statedef-input-image"
								id="ref-for-element-statedef-input-image④">Image Button</a>
						</code></td>
					<td><font style="vertical-align: inherit;"><font
							style="vertical-align: inherit;">특정 이미지의 크기에 비례하여 마지막으로
								선택된 값이어야하며 </font><a data-link-type="dfn"
							href="sec-forms.html#form-submission"
							id="ref-for-form-submission②"><font
								style="vertical-align: inherit;">양식 제출을</font></a><font
							style="vertical-align: inherit;"> 시작하는 추가 의미를 갖는 좌표</font></font><a
						data-link-type="dfn" href="sec-forms.html#form-submission"
						id="ref-for-form-submission②"><font
							style="vertical-align: inherit;"></font></a></td>
					<td>
	...
	<form action="/form/saveMultiParamForm.bt" method="post">
		<h1>Multi Form (2)</h1>
		<table id="attr-input-type-keywords">
			<thead>
				<tr>
